...
export default function Etapa3() {
  ...
  function proximoDigito() {
    ...
    while (
      context.randomNumber1 == context.digito4 ||
      context.randomNumber2 == context.digito4 ||
      context.randomNumber3 == context.digito4
    ) {
      if (context.randomNumber1 == context.digito4) {
        context.randomNumber1 = getRandomInt(0, 9).toString();
      }
      if (context.randomNumber2 == context.digito4) {
        context.randomNumber2 = getRandomInt(0, 9).toString();
      }
      if (context.randomNumber3 == context.digito4) {
        context.randomNumber3 = getRandomInt(0, 9).toString();
      }
    ...
    <>
      <SafeAreaView style={styles.container}>
        ...
        <DescricaoComponent
          ...
          descricao="Selecione o bloco que contém o 3º dígito da sua senha"
        />
