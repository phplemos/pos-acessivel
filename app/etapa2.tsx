...
export default function Etapa2() {
  ...
  useEffect(() => {
    ...
    if (
      context.digito2 == context.randomNumber1 ||
      context.digito2 == context.randomNumber2
    ) {
      context.randomNumber1 = getRandomInt(0, 9).toString();
      context.randomNumber2 = getRandomInt(0, 9).toString();
    }
  ...
  return (
    <>
      <SafeAreaView style={styles.container}>
        ...
        <DescricaoComponent
          titulo="Dígito"
          tituloDestaque="2 de 4"
          descricao="Selecione o bloco que contém o 2º dígito da sua senha"
        />
